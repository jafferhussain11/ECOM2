...
window.addEventListener('load', () => {
    ...
    console.log('loaded');
    const page = 1;
    axios.get(`http://13.234.120.222:3000/products?page=${page}`).then((products) => {
...
btn.addEventListener('click', () => {
    ...
    const page = 1;
    axios.get(`http://13.234.120.222:3000/cart?page=${page}`).then((cartProducts) => {
...
document.addEventListener('click', (e) => {
    ...
    if(e.target.id == 'addbutn') {
        ...
        //console.log(id);
        axios.post('http://13.234.120.222:3000/cart', {
            id: id,
            ...
            if(res.status == 200) {
                ...
                axios.get(`http://13.234.120.222:3000/cart?page=1`).then((cartProducts) => {
    ...
    if(e.target.id == 'checkout') {
        ...
        axios.post('http://13.234.120.222:3000/create-order').then((res) => {
            if(res.status == 200) {
